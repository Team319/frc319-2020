...
// }
//
// if (!talon.isMotionProfileTopLevelBufferFull() && lastPointSent <
// prof.numPoints) {
...
//
// loadLeftBuffer = new Notifier(new BufferLoader(rightTalon,
...
// private void resetTalon(TalonSRX talon, ControlMode controlMode, double
// setValue) {
// talon.clearMotionProfileTrajectories();
// talon.clearMotionProfileHasUnderrun(10);
